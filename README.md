...
Module to install Watson-Studio service on Cloud Pak for Data. As per instructions mentioned in https://www.ibm.com/docs/en/cloud-paks/cp-data/4.0?topic=studio-installing-watson
